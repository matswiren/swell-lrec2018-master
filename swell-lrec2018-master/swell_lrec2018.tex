...
\name{Dan Rosén, Mats Wirén, Elena Volodina}

\address{Språkbanken, Stockholms Universitet, Språkbanken\\
...
Felix Hultin + bib reference (also in introduction/background)
