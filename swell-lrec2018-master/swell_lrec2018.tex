...
\includegraphics[height=2cm, trim={-0.5cm 0.55cm 0 0}, clip]{#1.pdf}
...
\caption{Example normalisation steps.}
\end{figure}
...
\featuresF{features6}{Alternative analysis to illustrate redundant word.}
